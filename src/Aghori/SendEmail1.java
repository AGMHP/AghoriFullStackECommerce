...
public class SendEmail1 {
	...
	private String FROM_ADDRESS ="parth11041998@gmail.com";
	private String PASSWORD ="8734804205";
	private String FROM_NAME="ABC";
	
	
	public boolean sendMail(String[] recepients, String[] bccRecepients,String name, String subject,String message)
	{
		...
		try{
			...
			System.out.println(message+recepients[0]+bccRecepients[0]);
